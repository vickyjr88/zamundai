...
openclaw config set agents.defaults.model.primary "\"${OPENCLAW_DEFAULT_MODEL}\"" --strict-json
openclaw config set gateway.controlUi.allowedOrigins "$OPENCLAW_ALLOWED_ORIGINS_JSON" --strict-json 
